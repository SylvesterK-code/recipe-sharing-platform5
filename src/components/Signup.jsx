...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-200 to-green-500px-4 py-12">
      <div className="bg-white  shadow-2xl rounded-2xl p-8 w-full max-w-md">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          {/* Full Name */}
          <div>
            <label className="text-gray-700 z font-semibold mb-1 block">
              Full Name
            </label>
